...
const UNOFFICIAL = 'https://unofficial-builds.nodejs.org/download/release/index.json';
...
async function resolveVersion(tag, opts) {
  ...
  let url = undefined;
  if (opts.platform && opts.arch) {
    const urlBase = match.unofficial ? 'https://unofficial-builds.nodejs.org/download/release' : 'https://nodejs.org/dist';
